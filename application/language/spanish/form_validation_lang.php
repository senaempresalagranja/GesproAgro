...
$lang['less_than_equal_to']	= "El campo %s debe contener un número menor igual que %s.";
$lang['stock_max']	        = "El campo %s debe contener un número menor igual que %s.";
$lang['intervalo_uno_cinco']= "El campo %s debe contener numeros de un decimal en el intervalo del 1 al 5";
/* Added after 2.0.2 */
